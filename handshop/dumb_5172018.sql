...
-- Dumping data for table shophandmade.chitietdonhang: ~7 rows (approximately)
...
-- Dumping data for table shophandmade.donhang: ~20 rows (approximately)
...
INSERT INTO `sanpham` (`ID_SANPHAM`, `TEN_SANPHAM`, `GIA`, `MO_TA`, `TINH_TRANG`, `ID_LOAIHANG`, `GIAM_GIA`, `IMAGES`, `SO_LUONG`) VALUES
	(2, 'Gối nhỏ có hình', 150000, 'Hàng mới', 0, 1, 0, 'images/pic_1.jpg', 1),
	(3, 'Gối lớn hình cá heo', 250000, 'Hàng mới', 0, 1, 0, 'images/pic_2.jpg', 1),
	(4, 'Thú bông vịt con', 200000, 'Hàng mới', 0, 1, 0, 'images/pic_3.jpg', 1),
	(5, 'Gối hình cá heo', 100000, 'Hàng mới', 0, 1, 0, 'images/pic_5.jpg', 1),
	(6, 'Túi dây rút hình cà rốt', 40000, 'Hàng mới', 0, 2, 0, 'images/pic_6.jpg', 1),
	(7, 'Gối hình trái tim', 80000, 'Áo gối', 0, 3, 0, 'images/pic_7.jpg', 1),
	(12, 'Gối kê cổ', 80000, 'Đồ handmade', 0, 2, 0, 'images/pic_8.jpg', 1),
	(13, 'Gối kê cổ angry bird', 50000, 'Hàng xách tay từ Mỹ', 0, 1, 0, 'images/pic_8.jpg', 1),
	(14, 'Áo sơ mi trắng', 150000, 'Áo sơ mi trắng size S, M, L, XL ', 0, 2, 10, 'images/pr2.jpg', 1),
	(1000, 'Áo sơ mi xanh', 150000, 'THÔNG TIN SẢN PHẨM\r\nÁo sơ mi nam – Chất liệu poplin, bề mặt vải ít nhăn, kết cấu chặt chẽ, xang bông mềm mại, tạo cảm giác mịn màng, thấm mồ hôi, thoáng mát.\r\n- Sản phẩm có màu sắc đen, trắng tao nhã kết hợp với hình rồng thêu màu xanh cá tính, tạo nên vẻ đẹp thanh lịch và sang trọng cho người mặc.\r\n- Kiểu dáng Slimfit – form ôm.\r\n- Cổ áo kiểu cổ bẻ Đức khỏe khoắn.\r\n- Chỉ thêu sản xuất tại Việt Nam, bền màu không độc hại.\r\n- Thông số mẫu: Cao 1.72m - Nặng 73kg - Size áo L', 0, 12, NULL, 'images/pi3.png', 10),
...
-- Dumping data for table shophandmade.taikhoan: ~8 rows (approximately)
