		...
		<div class="container">
			...
			<div class="account_grid">
				<div class="col-md-6 login-right"
					style="margin-left: 25%; text-align: center">
					<table>
						<form action="LoginServlet" method="POST">
							...
							<tr>
								...
								<td><input type="password" name="password"
									class="form-control" placeholder="Mật khẩu"></td>

							</tr>
							<tr>
								<td></td>
								<td><a class="forgot" href="#">Quên mật khẩu?</a> <input
									type="submit" value="Đăng nhập"> <label
									style="color: red;"><%=errPass%></label></td>
							</tr>
							</tr>
						</form>
					</table>
